## rocon_concert (indigo) - 0.6.11-1

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --edit-track --track indigo --rosdistro indigo rocon_concert` on `Wed, 12 Oct 2016 00:58:09 -0000`
...
## rocon_concert (indigo) - 0.6.11-0

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_concert -t indigo -r indigo` on `Fri, 28 Aug 2015 01:29:46 -0000`
...
## rocon_concert (indigo) - 0.6.9-0

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_concert -t indigo -r indigo` on `Thu, 09 Jul 2015 06:02:48 -0000`
...
## rocon_concert (indigo) - 0.6.8-0

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_concert -t indigo -r indigo` on `Mon, 27 Apr 2015 08:20:41 -0000`
...
## rocon_concert (indigo) - 0.6.7-0

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_concert -t indigo -r indigo` on `Mon, 06 Apr 2015 09:45:27 -0000`
...
## rocon_concert (indigo) - 0.6.6-0

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_concert -t indigo -r indigo` on `Mon, 23 Mar 2015 08:45:10 -0000`
...
## rocon_concert (indigo) - 0.6.5-0

The packages in the `rocon_concert` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_concert -t indigo -r indigo` on `Fri, 27 Feb 2015 07:34:25 -0000`
